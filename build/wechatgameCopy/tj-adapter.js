 ...
 (function (modules) {
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        function inject() {
            ...
            const _wx$getSystemInfoSync = tj.getSystemInfoSync();
...
//            };
        ...
        const XMLHttpRequest = (function () {
            ...
            function XMLHttpRequest() {
                ...
                _responseHeader.set(this, {});
                    ...
                    key: 'open',
                    value: function open(method, url , async=true) {
                        _method.set(this, method);
                        _url.set(this, url);
                        _async.set(this, async);
                        ...
                        if (this.readyState !== XMLHttpRequest.OPENED) {
                            ...
                            tj.request({
                                ...
                                fail: function fail(_ref2) {
                                    const { errMsg } = _ref2;
                                    if (errMsg && errMsg.indexOf('abort') !== -1) {
        ...
        const localStorage = {
            get length() {
                const _wx$getStorageInfoSyn = tj.getStorageInfoSync();
                const { keys } = _wx$getStorageInfoSyn;
                return keys.length;
            },
            key: function key(n) {
                const _wx$getStorageInfoSyn2 = tj.getStorageInfoSync();
