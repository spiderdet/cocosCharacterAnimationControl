...
console.log(`typeof global.WebAssembly: ${typeof global.WebAssembly}, global.WebAssembly: ${global.WebAssembly}`);
console.trace();
...
// // test.showTest(4);
// test.showTest = test.showOverride;
// test.showTest(4);

// fs1 = require('./fs.js');
// console.log(`typeof fs :${typeof fs}`);
// console.log(`typeof fs1.readFileSync :${typeof fs1.readFileSync}`);

var fs = wx.getFileSystemManager ? wx.getFileSystemManager() : null;
console.log(`typeof fs :${typeof fs}`);
console.log(`typeof fs.readFileSync :${typeof fs.readFileSync}`);
